...
//   随机字符串子域、punycode 混淆。
import { registrableDomain, isOfficialDomain, PLATFORM_TRUST, OFFICIAL_DOMAINS } from "./host.js";
...
// registrableDomain / isOfficialDomain / PLATFORM_TRUST / OFFICIAL_DOMAINS 由 lib/host.js 统一导出
...
export function evaluateUrl(url, bl, opts = {}) {
  ...
  if (!onPlatform) {
    ...
    for (const brand of BRANDS) {
      ...
      if (isOfficialDomain(rd, brand)) continue;
